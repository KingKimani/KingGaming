...
<body>
	...
	<div class="container text-center">
		<div class="row">
			...
			<div class="col-sm-4">
				<h2>Console Maintenance & Repair</h2>

						<h3><a href="#hidden1" data-toggle="collapse">Details</a></h3>
					<div id="hidden1" class="collapse">

							<p>Your gaming console is easily one of the most prized possessions you own. It is there for you in good times and bad, and no matter how hard of a day you have, you know your gaming console will be there waiting for you. So when your console breaks, it can feel like your world stops. You want your console fixed, and you want it fixed now. Luckily for you, you have come to the right place.</p>
					</div>
			</div>
			<div class="col-sm-4">
