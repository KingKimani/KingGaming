...
<body>
	...
	<div class="container text-center">
		...
		<div class="row">
			...
			<div class="col-sm-12">
				<h1 class="header1">KingGaming</h1>
				<h1>Overview of the Company</h1>
				<h3>The mission of company is to provide a quality and affordable product to fulfill the needs of customers. The vision is to give the quality and high standard product to satisfy the needs of the customers. </h3>
			</div>
